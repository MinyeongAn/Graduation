...
public class LoginMenu : MonoBehaviour
{
    ...
    IEnumerator LoginUser()
    {
        ...
        else
        {
            ...
            if (response == "UserError")
            {
                ...
                Login_ErrorText.text = "오류: 아이디를 찾을수가 없습니다.";
            }
            else
            {
    ...
    IEnumerator RegisterUser()
    {
        ...
        else
        {
            ...
            if (response == "UserError")
            {
                ...
                Register_ErrorText.text = "오류: 아이디가 이미 사용중입니다.";
            }
            else
            {
                //There was another error. This error message should never appear, but is here just in case.
    ...
    public void Login_LoginButtonPressed()
    {
        ...
        else
        {
            ...
            Login_ErrorText.text = "오류: 아이디가 부정확합니다.";
        }
    }
        ...
        if (username.Length > 3)
        {
            if (password.Length > 5)
            {
                ...
                else
                {
                    ...
                    Register_ErrorText.text = "오류: 비밀번호가 맞지 않습니다.";
                }
            }
            else
            {
                //Password too short so show error
                Register_ErrorText.text = "오류: 비밀번호가 너무 짧습니다.";
            }
        }
        else
        {
            //Username too short so show error
            Register_ErrorText.text = "오류: 아이디가 너무 짧습니다.";
        }
    }
